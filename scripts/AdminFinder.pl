...
system('cls');
system('title Admin Control Panel Finder v1 final by ddosser');
 
print"\n";
print "-----------------------------------------------\n" ;
print "[*]--Admin Control Panel Finder v 1 --------[*]\n" ;
print "[*]-------------Coded By ddosser----------[*]\n" ;
print "[*]------www.youtube.com/dosserize---------[*]\n" ;
print "[*]------------Gr33tz #loc--------------[*]\n" ;
print "*******************************************\n" ;
print "\n";
 
print "~# coloque o site\n* ex: www.domaine.com ou www.domaine.com/path\n-> ";
$site=<STDIN>;
chomp $site;
 
print "\n";
print "~ Entre a linguagem do site \n* ex: asp, php, cfm\n-> ";
$code=<STDIN>;
chomp($code);
...
print "->o site: $site\n";
print "->Linguagem do site: $code\n";
print "->Escaneando paginas de admin...\n\n\n";
